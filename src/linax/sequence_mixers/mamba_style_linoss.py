...
from linax.sequence_mixers.linoss import LinOSSSequenceMixer, LinOSSSequenceMixerConfig
...
class MambaStyleLinOSSSequenceMixerConfig(SequenceMixerConfig):
    ...
    def build(self, in_features: int, key: PRNGKeyArray) -> MambaStyleLinOSSSequenceMixer:
        """Build the Mamba-style LinOSS sequence mixer."""
        return MambaStyleLinOSSSequenceMixer(in_features=in_features, cfg=self, key=key)
